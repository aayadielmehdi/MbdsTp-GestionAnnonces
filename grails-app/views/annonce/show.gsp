...
%{--            <f:display bean="annonce" />--}%
    ...
    <ol class="property-list annonce">
        ...
        <li class="fieldcontain">
            <span id="validTill-label" class="property-label">Date Validitée</span>
            <div class="property-value" aria-labelledby="validTill-label">
                <g:formatDate date="${annonce.validTill}" type="datetime" style="medium" />
            </div>
        </li>
        ...
        <li class="fieldcontain">
            <span id="state-label" class="property-label">Etat</span>
